...
static const uint8_t sh1priv[] = {0x58, 0xc4, 0x81, 0x88, 0xf8, 0xb1, 0xcb, 0xd4, 0x19, 0x00, 0x2e,
...
static const uint8_t sh1pub[] = {0xe1, 0xdc, 0xf9, 0xc3, 0x46, 0xbc, 0xf2, 0xe7, 0x8b, 0xa8, 0xf0,
...
static const uint8_t sh2priv[] = {0x00, 0x40, 0x5e, 0x19, 0x46, 0x75, 0xab, 0xe1, 0x5f, 0x0b, 0x57,
...
static const uint8_t sh2pub[] = {0x66, 0xb9, 0x92, 0x5a, 0x85, 0x66, 0xe8, 0x09, 0x5c, 0x56, 0x80,
...
static const uint8_t sh3priv[] = {0xb0, 0x90, 0x9f, 0xe1, 0xf3, 0x1f, 0xa1, 0x21, 0x75, 0xef, 0x45,
...
static const uint8_t sh3pub[] = {0x22, 0x57, 0xa8, 0x2f, 0x85, 0x8f, 0x13, 0x32, 0xfa, 0x0f, 0xf6,
...
void lt_test_ire_pairing_key_slots(lt_handle_t *h)
{
    ...
    for (uint8_t i = TR01_PAIRING_KEY_SLOT_INDEX_1; i <= TR01_PAIRING_KEY_SLOT_INDEX_3; i++) {
        ...
        LT_TEST_ASSERT(LT_OK,
                       lt_print_bytes(pub_keys[i], TR01_SHIPUB_LEN, print_buff, PRINT_BUFF_SIZE));
        LT_LOG_INFO("%s", print_buff);
    ...
    for (uint8_t i = TR01_PAIRING_KEY_SLOT_INDEX_1; i <= TR01_PAIRING_KEY_SLOT_INDEX_3; i++) {
        ...
        LT_TEST_ASSERT(LT_OK,
                       lt_verify_chip_and_start_secure_session(h, priv_keys[i], pub_keys[i], i));
