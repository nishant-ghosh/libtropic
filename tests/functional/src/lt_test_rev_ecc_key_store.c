...
uint8_t p256_priv_test_key[] = {0x7d, 0x35, 0xc5, 0x0a, 0xfe, 0x9b, 0x15, 0xeb, 0x41, 0x16, 0xcb,
                                0x9b, 0xaa, 0xc2, 0xcb, 0xdd, 0xbb, 0xdc, 0xb9, 0xb8, 0x77, 0xc7,
                                0x0f, 0x9e, 0x21, 0x8c, 0x2c, 0xff, 0xaa, 0x8b, 0x6f, 0x72};
...
uint8_t ed25519_priv_test_key[] = {0x73, 0x5b, 0x09, 0xb9, 0x5f, 0x4e, 0x17, 0x83, 0x4f, 0xa0, 0x7e,
                                   0x93, 0x14, 0xa8, 0x7b, 0xa8, 0x86, 0x36, 0x00, 0x30, 0x7f, 0x90,
                                   0xf2, 0x3d, 0x52, 0x4c, 0xac, 0x15, 0x5f, 0x94, 0x44, 0xe0};
uint8_t ed25519_pub_test_key[] = {0xde, 0x86, 0x1d, 0xac, 0xc2, 0x36, 0x4a, 0xe0, 0x5f, 0xb4, 0xef,
                                  0x3c, 0xfc, 0xc1, 0xb2, 0x41, 0xab, 0x51, 0xdb, 0xc6, 0x38, 0xfc,
                                  0x84, 0xb2, 0x5f, 0x04, 0xe6, 0x58, 0x5a, 0xd5, 0x3c, 0xcd};
...
void lt_test_rev_ecc_key_store(lt_handle_t *h)
{
    ...
    for (uint8_t i = TR01_ECC_SLOT_0; i <= TR01_ECC_SLOT_31; i++) {
        ...
        LT_TEST_ASSERT(LT_L3_FAIL,
                       lt_ecc_key_store(h, i, TR01_CURVE_P256, p256_invalid_priv_test_key));
