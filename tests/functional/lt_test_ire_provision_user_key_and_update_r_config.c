...
static void create_r_config(struct lt_config_t *r_config)
{
    ...
    // 1. Disable write privileges for all keys
    ...
    r_config->obj[TR01_CFG_UAP_PAIRING_KEY_WRITE_IDX] &= ~LT_TO_PAIRING_KEY_SH3(
        LT_SESSION_SH0_HAS_ACCESS | LT_SESSION_SH1_HAS_ACCESS | LT_SESSION_SH2_HAS_ACCESS | LT_SESSION_SH3_HAS_ACCESS);
    // 2. Enable access for admin key
    r_config->obj[TR01_CFG_UAP_PAIRING_KEY_WRITE_IDX] |= (LT_TO_PAIRING_KEY_SH0(LT_SESSION_SH1_HAS_ACCESS) | 
                                                        LT_TO_PAIRING_KEY_SH1(LT_SESSION_SH1_HAS_ACCESS) | 
                                                        LT_TO_PAIRING_KEY_SH2(LT_SESSION_SH1_HAS_ACCESS) | 
                                                        LT_TO_PAIRING_KEY_SH3(LT_SESSION_SH1_HAS_ACCESS));

    //------- TR01_CFG_UAP_PAIRING_KEY_READ ----------------------
    // 1. Disable read privileges for all keys
    ...
    r_config->obj[TR01_CFG_UAP_PAIRING_KEY_READ_IDX] &= ~LT_TO_PAIRING_KEY_SH3(
        LT_SESSION_SH0_HAS_ACCESS | LT_SESSION_SH1_HAS_ACCESS | LT_SESSION_SH2_HAS_ACCESS | LT_SESSION_SH3_HAS_ACCESS);
    // 2. Enable access for admin and user keys
    r_config->obj[TR01_CFG_UAP_PAIRING_KEY_READ_IDX] |= (LT_TO_PAIRING_KEY_SH0(LT_SESSION_SH1_HAS_ACCESS | LT_SESSION_SH2_HAS_ACCESS) | 
                                                        LT_TO_PAIRING_KEY_SH1(LT_SESSION_SH1_HAS_ACCESS | LT_SESSION_SH2_HAS_ACCESS) | 
                                                        LT_TO_PAIRING_KEY_SH2(LT_SESSION_SH1_HAS_ACCESS | LT_SESSION_SH2_HAS_ACCESS) | 
                                                        LT_TO_PAIRING_KEY_SH3(LT_SESSION_SH1_HAS_ACCESS | LT_SESSION_SH2_HAS_ACCESS));
    ...
    // 1. Disable access for all keys
    r_config->obj[TR01_CFG_UAP_R_CONFIG_WRITE_ERASE_IDX] &= ~LT_TO_PAIRING_KEY_SH0(
        LT_SESSION_SH0_HAS_ACCESS | LT_SESSION_SH1_HAS_ACCESS | LT_SESSION_SH2_HAS_ACCESS | LT_SESSION_SH3_HAS_ACCESS);
    // 2. Enable access for admin and user keys
    r_config->obj[TR01_CFG_UAP_R_CONFIG_WRITE_ERASE_IDX] |= (LT_TO_PAIRING_KEY_SH0(LT_SESSION_SH1_HAS_ACCESS | LT_SESSION_SH2_HAS_ACCESS) | 
                                                        LT_TO_PAIRING_KEY_SH1(LT_SESSION_SH1_HAS_ACCESS | LT_SESSION_SH2_HAS_ACCESS) | 
                                                        LT_TO_PAIRING_KEY_SH2(LT_SESSION_SH1_HAS_ACCESS | LT_SESSION_SH2_HAS_ACCESS) | 
                                                        LT_TO_PAIRING_KEY_SH3(LT_SESSION_SH1_HAS_ACCESS | LT_SESSION_SH2_HAS_ACCESS));
    ...
    r_config->obj[TR01_CFG_UAP_R_CONFIG_READ_IDX] &= ~LT_TO_PAIRING_KEY_SH0(
        ...
        LT_SESSION_SH0_HAS_ACCESS | LT_SESSION_SH1_HAS_ACCESS | LT_SESSION_SH2_HAS_ACCESS | LT_SESSION_SH3_HAS_ACCESS);
    // 2. Enable access for admin and user keys
    r_config->obj[TR01_CFG_UAP_R_CONFIG_READ_IDX] |= (LT_TO_PAIRING_KEY_SH0(LT_SESSION_SH1_HAS_ACCESS | LT_SESSION_SH2_HAS_ACCESS) | 
                                                        LT_TO_PAIRING_KEY_SH1(LT_SESSION_SH1_HAS_ACCESS | LT_SESSION_SH2_HAS_ACCESS) | 
                                                        LT_TO_PAIRING_KEY_SH2(LT_SESSION_SH1_HAS_ACCESS | LT_SESSION_SH2_HAS_ACCESS) | 
                                                        LT_TO_PAIRING_KEY_SH3(LT_SESSION_SH1_HAS_ACCESS | LT_SESSION_SH2_HAS_ACCESS));
    ...
    r_config->obj[TR01_CFG_UAP_I_CONFIG_WRITE_IDX] &= ~LT_TO_PAIRING_KEY_SH0(
        ...
        LT_SESSION_SH0_HAS_ACCESS | !(LT_SESSION_SH1_HAS_ACCESS) | LT_SESSION_SH2_HAS_ACCESS | LT_SESSION_SH3_HAS_ACCESS);
    // 2. Enable access for admin key
    r_config->obj[TR01_CFG_UAP_I_CONFIG_WRITE_IDX] |= (LT_TO_PAIRING_KEY_SH0(LT_SESSION_SH1_HAS_ACCESS) | 
                                                        LT_TO_PAIRING_KEY_SH1(LT_SESSION_SH1_HAS_ACCESS) | 
                                                        LT_TO_PAIRING_KEY_SH2(LT_SESSION_SH1_HAS_ACCESS) | 
                                                        LT_TO_PAIRING_KEY_SH3(LT_SESSION_SH1_HAS_ACCESS));
    ...
    r_config->obj[TR01_CFG_UAP_I_CONFIG_READ_IDX] &= ~LT_TO_PAIRING_KEY_SH0(
        ...
        LT_SESSION_SH0_HAS_ACCESS | LT_SESSION_SH1_HAS_ACCESS | LT_SESSION_SH2_HAS_ACCESS | LT_SESSION_SH3_HAS_ACCESS);
    // 2. Enable access for admin and user keys
    r_config->obj[TR01_CFG_UAP_I_CONFIG_READ_IDX] |= (LT_TO_PAIRING_KEY_SH0(LT_SESSION_SH1_HAS_ACCESS | LT_SESSION_SH2_HAS_ACCESS) | 
                                                        LT_TO_PAIRING_KEY_SH1(LT_SESSION_SH1_HAS_ACCESS | LT_SESSION_SH2_HAS_ACCESS) | 
                                                        LT_TO_PAIRING_KEY_SH2(LT_SESSION_SH1_HAS_ACCESS | LT_SESSION_SH2_HAS_ACCESS) | 
                                                        LT_TO_PAIRING_KEY_SH3(LT_SESSION_SH1_HAS_ACCESS | LT_SESSION_SH2_HAS_ACCESS));
    ...
    r_config->obj[TR01_CFG_UAP_R_MEM_DATA_WRITE_IDX] &= ~LT_TO_PAIRING_KEY_SH3(
        LT_SESSION_SH0_HAS_ACCESS | LT_SESSION_SH1_HAS_ACCESS | LT_SESSION_SH2_HAS_ACCESS | LT_SESSION_SH3_HAS_ACCESS);
    // 2. Admin key has access to all slots. User key has access to slots 128-511
    r_config->obj[TR01_CFG_UAP_R_MEM_DATA_WRITE_IDX] |= (LT_TO_PAIRING_KEY_SH0(LT_SESSION_SH1_HAS_ACCESS) | 
                                                        LT_TO_PAIRING_KEY_SH1(LT_SESSION_SH1_HAS_ACCESS | LT_SESSION_SH2_HAS_ACCESS) | 
                                                        LT_TO_PAIRING_KEY_SH2(LT_SESSION_SH1_HAS_ACCESS | LT_SESSION_SH2_HAS_ACCESS) | 
                                                        LT_TO_PAIRING_KEY_SH3(LT_SESSION_SH1_HAS_ACCESS | LT_SESSION_SH2_HAS_ACCESS));
    ...
    r_config->obj[TR01_CFG_UAP_R_MEM_DATA_READ_IDX] &= ~LT_TO_PAIRING_KEY_SH3(
        LT_SESSION_SH0_HAS_ACCESS | LT_SESSION_SH1_HAS_ACCESS | LT_SESSION_SH2_HAS_ACCESS | LT_SESSION_SH3_HAS_ACCESS);
    // 2. Admin key has access to all slots. User key has access to slots 128-511
    r_config->obj[TR01_CFG_UAP_R_MEM_DATA_READ_IDX] |= (LT_TO_PAIRING_KEY_SH0(LT_SESSION_SH1_HAS_ACCESS) | 
                                                        LT_TO_PAIRING_KEY_SH1(LT_SESSION_SH1_HAS_ACCESS | LT_SESSION_SH2_HAS_ACCESS) | 
                                                        LT_TO_PAIRING_KEY_SH2(LT_SESSION_SH1_HAS_ACCESS | LT_SESSION_SH2_HAS_ACCESS) | 
                                                        LT_TO_PAIRING_KEY_SH3(LT_SESSION_SH1_HAS_ACCESS | LT_SESSION_SH2_HAS_ACCESS));
    ...
    r_config->obj[TR01_CFG_UAP_R_MEM_DATA_ERASE_IDX] &= ~LT_TO_PAIRING_KEY_SH3(
        LT_SESSION_SH0_HAS_ACCESS | LT_SESSION_SH1_HAS_ACCESS | LT_SESSION_SH2_HAS_ACCESS | LT_SESSION_SH3_HAS_ACCESS);
    // 2. Admin key has access to all slots. User key has access to slots 128-511
    r_config->obj[TR01_CFG_UAP_R_MEM_DATA_ERASE_IDX] |= (LT_TO_PAIRING_KEY_SH0(LT_SESSION_SH1_HAS_ACCESS) | 
                                                        LT_TO_PAIRING_KEY_SH1(LT_SESSION_SH1_HAS_ACCESS | LT_SESSION_SH2_HAS_ACCESS) | 
                                                        LT_TO_PAIRING_KEY_SH2(LT_SESSION_SH1_HAS_ACCESS | LT_SESSION_SH2_HAS_ACCESS) | 
                                                        LT_TO_PAIRING_KEY_SH3(LT_SESSION_SH1_HAS_ACCESS | LT_SESSION_SH2_HAS_ACCESS));
