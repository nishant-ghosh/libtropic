...
const uint8_t lt_sh0priv_eng_sample[] = {
...
const uint8_t lt_sh0pub_eng_sample[] = {
...
const uint8_t lt_sh0priv_prod0[] = {0x28, 0x3f, 0x5a, 0x0f, 0xfc, 0x41, 0xcf, 0x50, 0x98, 0xa8, 0xe1,
